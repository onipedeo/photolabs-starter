    ...
    <>
      <div className="photo-details-modal">
        <button className="photo-details-modal__close-button" >
          <img onClick={props.closeModal} src={closeSymbol} alt="close symbol" />
        </button>
        ...
        <div className="photo-details-modal__images">
          ...
          <PhotoList photos={Object.values(similar_photos)} toggleFavorite={toggleFavorite} favoritedPhotos={favoritedPhotos} />
        </div>
      </div>
    </>
  )
